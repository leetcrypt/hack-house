...
(`$HH_PAGER_PAYLOADS`, default `~/pineapple-pager-c2/payloads/`, minus the hak5 reference mirror) is
...
HOST_LIB = os.environ.get("HH_PAGER_PAYLOADS") or os.path.expanduser("~/pineapple-pager-c2/payloads")
